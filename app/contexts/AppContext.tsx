...
const mockApps: MiniApp[] = [
  ...
  },
  {
    ...
    is_trending: false,
    long_description: 'Professional calculator with advanced features.',
    tags: ['math', 'calc'],
    screenshots: [],
  ...
  },
  {
    ...
    is_new_this_week: false,
    is_trending: false,
    long_description: 'Get accurate weather forecasts for your location.',
  ...
  },
  {
    ...
    is_new_this_week: true,
    is_trending: true,
    long_description: 'Take notes on the go with rich formatting.',
    tags: ['notes', 'organize'],
    screenshots: [],
  ...
  },
  {
    ...
    is_new_this_week: false,
    is_trending: true,
    long_description: 'Collection of fun mini games for everyone.',
    tags: ['games', 'fun'],
    screenshots: [],
  ...
  },
  {
    ...
    is_new_this_week: true,
    is_trending: false,
    long_description: 'Manage your tasks efficiently.',
    tags: ['todo', 'tasks'],
    screenshots: [],
  ...
  },
  {
    ...
    is_new_this_week: false,
    is_trending: false,
    long_description: 'Monitor your fitness progress.',
    tags: ['fitness', 'track'],
    screenshots: [],
